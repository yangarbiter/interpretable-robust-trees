...
def setup_experiments(auto_var):
    _register_experiment(auto_var, 'lin_sep_bbm_rob_3')
    _register_experiment(auto_var, 'risk_slim_3')
    _register_experiment(auto_var, 'dt_interpret_rob_3')
    _register_experiment(auto_var, 'xgboostrobdt_interpret_rob')

    _register_experiment(auto_var, 'calc_lin_separation')
    _register_experiment(auto_var, 'calc_separation')
...
class RSepExperiments(Experiments):
